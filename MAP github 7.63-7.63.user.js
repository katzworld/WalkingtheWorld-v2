...
(function () {
    ...
    var onKeyEvent = function (ev) {
        var state = "pressed";
        //console.log(event)
        if (ev.code == 'KeyP') { // little P no SHIFT
            document.querySelector("body > div.plot_id_cont_on_screen").hidden = !document.querySelector("body > div.plot_id_cont_on_screen").hidden;
            document.querySelector("#chat_cont").hidden = !document.querySelector("#chat_cont").hidden;
            document.querySelector("#compas_cont").hidden = !document.querySelector("#compas_cont").hidden;
            document.querySelector("#compas_cont_NEWS").hidden = !document.querySelector("#compas_cont_NEWS").hidden;
            document.querySelector("#connection_bar").hidden = !document.querySelector("#connection_bar").hidden;
            //document.querySelector("#title_container").hidden = !document.querySelector("#title_container").hidden;
        }
